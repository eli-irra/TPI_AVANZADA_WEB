        ...
        <tbody>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/SvVerReporte" method="GET" class="form-inline">
                        ...
                        <form action="${pageContext.request.contextPath}/SvModificarReporte" method="GET" class="form-inline">
                        ...
                        <form action="${pageContext.request.contextPath}/SvEliminarReporte" method="POST" class="form-inline">
                            <input type="hidden" name="idEliminar" value="<%= r.getIdReporte() %>">
                            <button type="submit" class="btn-icon-danger" onclick="return confirm('¿Eliminar este reporte?');" title="Borrar">
            ...
            <% }} else { %>
                <tr><td colspan="4" class="text-center">No hay reportes registrados.</td></tr>
            <% } %>
        </tbody>
    </table>
</div>
